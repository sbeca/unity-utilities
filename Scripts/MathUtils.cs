...
public static class MathUtils
{
    ...
    public static float Ease(float t, float k1, float k2)
    {
        ...
        f = k1 * 2.0f / Mathf.PI + k2 - k1 + (1.0f - k2) * 2.0f / Mathf.PI;
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    s = 2.0f * k1 / Mathf.PI + k2 - k1 + ((1.0f - k2) * (2.0f / Mathf.PI)) * Mathf.Sin(((t - k2) / (1.0f - k2)) * Mathf.PI / 2.0f);
                }
            }
        }
